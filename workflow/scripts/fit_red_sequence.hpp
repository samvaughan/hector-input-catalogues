...
class fit_red_sequence_model final : public model_base_crtp<fit_red_sequence_model> {
 ...
 public:
  ...
  fit_red_sequence_model(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "fit_red_sequence_model_namespace::fit_red_sequence_model";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "fit_red_sequence_model_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
             ...
             lp__);
      {
        ...
        lp_accum__.add(stan::math::normal_lpdf<propto__>(
                         stan::model::rvalue(slopes, "slopes",
                           stan::model::index_uni(1)), 0.07, 0.1));
        current_statement__ = 19;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(
                         stan::model::rvalue(slopes, "slopes",
                           stan::model::index_uni(2)), 0.00, 0.05));
        ...
        for (int i = 1; i <= N; ++i) {
          ...
          lp_accum__.add(stan::math::log_mix(mixture_prob,
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "fit_red_sequence_model_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        stan::model::assign(y_red,
          stan::math::normal_rng(
            ...
            * stan::model::rvalue(x, "x", stan::model::index_uni(i))) +
            stan::model::rvalue(intercepts, "intercepts",
              stan::model::index_uni(1))),
            stan::model::rvalue(scatter, "scatter", stan::model::index_uni(1)),
            base_rng__), "assigning variable y_red",
          stan::model::index_uni(i));
        ...
        stan::model::assign(y_blue,
          stan::math::normal_rng(
            ...
            * stan::model::rvalue(x, "x", stan::model::index_uni(i))) +
            stan::model::rvalue(intercepts, "intercepts",
              stan::model::index_uni(2))),
            stan::model::rvalue(scatter, "scatter", stan::model::index_uni(2)),
            base_rng__), "assigning variable y_blue",
          stan::model::index_uni(i));
        ...
        stan::model::assign(log_Pr, (lp1 -
          stan::math::log_sum_exp(lp1, lp2)), "assigning variable log_Pr",
          stan::model::index_uni(i));
      }
      out__.write(y_red);
      out__.write(y_blue);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      Eigen::Matrix<local_scalar_t__,-1,1> slopes =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(2, DUMMY_VAR__);
      current_statement__ = 1;
      stan::model::assign(slopes,
        in__.read<Eigen::Matrix<local_scalar_t__,-1,1>>(2),
        "assigning variable slopes");
      out__.write(slopes);
      Eigen::Matrix<local_scalar_t__,-1,1> intercepts =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(2, DUMMY_VAR__);
      current_statement__ = 2;
      ...
      Eigen::Matrix<local_scalar_t__,-1,1> scatter =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(2, DUMMY_VAR__);
      current_statement__ = 3;
      stan::model::assign(scatter,
        in__.read<Eigen::Matrix<local_scalar_t__,-1,1>>(2),
        "assigning variable scatter");
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      current_statement__ = 1;
      context__.validate_dims("parameter initialization", "slopes", "double",
        std::vector<size_t>{static_cast<size_t>(2)});
      current_statement__ = 2;
      context__.validate_dims("parameter initialization", "intercepts",
        "double", std::vector<size_t>{static_cast<size_t>(2)});
      current_statement__ = 3;
      context__.validate_dims("parameter initialization", "scatter",
        "double", std::vector<size_t>{static_cast<size_t>(2)});
      current_statement__ = 4;
      context__.validate_dims("parameter initialization", "mixture_prob",
        ...
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(2, DUMMY_VAR__);
      {
        ...
        for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
          current_statement__ = 1;
          stan::model::assign(slopes, slopes_flat__[(pos__ - 1)],
        ...
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(2, DUMMY_VAR__);
      {
        ...
        for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
          current_statement__ = 2;
          stan::model::assign(intercepts, intercepts_flat__[(pos__ - 1)],
      ...
      Eigen::Matrix<local_scalar_t__,-1,1> scatter =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(2, DUMMY_VAR__);
      {
        std::vector<local_scalar_t__> scatter_flat__;
        current_statement__ = 3;
        scatter_flat__ = context__.vals_r("scatter");
        current_statement__ = 3;
        pos__ = 1;
        current_statement__ = 3;
        for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
          current_statement__ = 3;
          stan::model::assign(scatter, scatter_flat__[(pos__ - 1)],
      ...
      local_scalar_t__ mixture_prob = DUMMY_VAR__;
      current_statement__ = 4;
      mixture_prob = context__.vals_r("mixture_prob")[(1 - 1)];
      out__.write_free_lub(0, 1, mixture_prob);
      local_scalar_t__ nu = DUMMY_VAR__;
      current_statement__ = 5;
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"y_red", "y_blue", "log_Pr"};
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
      param_names__.emplace_back(std::string() + "slopes" + '.' +
        std::to_string(sym1__));
    }
    for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
      param_names__.emplace_back(std::string() + "intercepts" + '.' +
        std::to_string(sym1__));
    }
    for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
      param_names__.emplace_back(std::string() + "scatter" + '.' +
        std::to_string(sym1__));
    }
    ...
    if (emit_generated_quantities__) {
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        param_names__.emplace_back(std::string() + "y_red" + '.' +
          std::to_string(sym1__));
      }
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        param_names__.emplace_back(std::string() + "y_blue" + '.' +
          std::to_string(sym1__));
      }
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        param_names__.emplace_back(std::string() + "log_Pr" + '.' +
          std::to_string(sym1__));
      }
    }
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((2 + 2) + 2) + 1) + 1);
