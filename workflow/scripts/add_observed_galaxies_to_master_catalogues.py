...
observed_galaxies_in_region = observed_galaxies_up_to_August2023.loc[
    observed_galaxies_up_to_August2023["Field"] == smk.wildcards.master_region
]
assert (
...
# If we're looking at the custers, get rid of non-members
if smk.wildcards == "Hector_Clusters":
    missing_galaxies = missing_galaxies.loc[missing_galaxies["ClusterMember"]]
